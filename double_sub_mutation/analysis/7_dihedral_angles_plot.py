...
# 2) Plot the omega angles ofr all 4 cases in one figure
...
fig.savefig(f'{cwd}/../omega_angles_{dir1}_{dir2}_step4_{end_step}.png',
...
def ramachandran_plot(dir, residues, case, phi, psi):
    ...
    fig.suptitle(
        f'Ramachandran plot for {case.strip()[:-1]} {case.strip()[-1]} angles', fontsize=24, color='black')
    fig.savefig(f'{cwd}/../ramchandran_plot_{dir}_upto_{end_step}_{case}.png',
                bbox_inches='tight', dpi=300)
